...
class DirectGallery extends ComponentBase
{
    protected $albums;
    protected $gallery;
    ...
    {
        return [
            'name' => 'chiragpatel.photoswipe::lang.components.directGallery.title',
            'description' => 'chiragpatel.photoswipe::lang.components.directGallery.description',
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            'gallery' => [
                'title' => 'chiragpatel.photoswipe::lang.components.directGallery.properties.gallery.title',
                'description' => 'chiragpatel.photoswipe::lang.components.directGallery.properties.gallery.description',
                'type' => 'dropdown',
                'placeholder' => 'Select Gallery',
                'showExternalParam' => false,
                'required' => true,
                'validationMessage' => 'Please Select Gallery.'
            ],
            'loop' => [
    ...
    {
        $galleries = Gallery::where('is_published',true)->orderBy('title', 'asc')->get()->toArray();

        if (!empty($galleries)) {
            $options = array_pluck($galleries, 'title', 'slug');
        }
        return $options;
    }
    ...
    public function onRun()
    {
        ...
        $this->prepareOptions();
        $gallery = $this->loadGallery($this->property('gallery'));
